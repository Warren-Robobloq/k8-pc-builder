...
"use strict";
/* WEBPACK VAR INJECTION */(function(module) {/* harmony import */ var _ponyfill_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(17);
/* global window */
...
var node_modules_warning_warning = __webpack_require__(2);
...
// CONCATENATED MODULE: ./src/reducers/code.js
const UPDATE_CODE = 'ide/code/UPDATE_CODE';
const initialState = {
  code: ``
};

const code_reducer = (state, action) => {
  const thatState = typeof state === 'undefined' ? initialState : state;

  switch (action.type) {
    case UPDATE_CODE:
      return Object.assign({}, thatState, {
        code: action.code
      });
...
var lodash_bindall = __webpack_require__(18);
...
// EXTERNAL MODULE: ./src/components/gui.css
var gui = __webpack_require__(13);
var gui_default = /*#__PURE__*/__webpack_require__.n(gui);

// CONCATENATED MODULE: ./src/components/Gui.jsx
...
const Gui_path = __webpack_require__(28);

const os = __webpack_require__(29);

const isDev = __webpack_require__(10).remote.require('electron-is-dev');

const drivelist = __webpack_require__(10).remote.require('drivelist');
...
class Gui_Gui extends react_default.a.Component {
  constructor(props) {
    super(props);
    lodash_bindall_default()(this, ['handleResetFireware']);
  }

  componentDidMount() {}

  async handleResetFireware() {
    try {
      const drives = await drivelist.list();

      const result = lodash_default.a.find(drives, drive => drive.mountpoints[0] && drive.mountpoints[0].label === 'ROBOBLOQ' && drive.isSystem === false || drive.size === 16760832 && drive.description === 'Buildwin Media-Player USB Device' // Windows
      );

      const drivePath = result ? result.mountpoints[0].path : `${app.getPath('downloads')}`;
      const fileName = 'K8.bin';
      const destination = Gui_path.resolve(drivePath, fileName);
      let sourcePath = app.getAppPath().replace('app.asar', `static/${fileName}`);

      if (isDev) {
        sourcePath = `./src/static/${fileName}`;
  ...
  render() {
    return react_default.a.createElement("div", {
      className: gui_default.a.wrapper
    }, react_default.a.createElement("button", {
      className: gui_default.a.resetFirmware,
      onClick: this.handleResetFireware
    }, "\u6062\u590D\u51FA\u5382\u56FA\u4EF6"));
  }

}

/* harmony default export */ var components_Gui = (Gui_Gui);
// CONCATENATED MODULE: ./src/components/Home.jsx



const Home = () => react_default.a.createElement("div", {
  className: "home"
}, react_default.a.createElement(components_Gui, null));
...
react_dom_default.a.render(react_default.a.createElement(components_Provider, {
  store: store
}, react_default.a.createElement(es_HashRouter, null, react_default.a.createElement("div", {
  className: "app"
